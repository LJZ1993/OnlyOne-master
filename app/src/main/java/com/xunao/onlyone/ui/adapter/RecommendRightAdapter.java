 ...
 */
public class RecommendRightAdapter extends SectionedBaseAdapter {

    private Context mContext;
    private String[] leftStr;
    private String[][] rightStr;

    public RecommendRightAdapter(Context context, String[] leftStr, String[][] rightStr) {
    ...
    public View getItemView(final int section, final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            layout = (LinearLayout) inflator.inflate(R.layout.item_recommend_right, null);
        } else {
