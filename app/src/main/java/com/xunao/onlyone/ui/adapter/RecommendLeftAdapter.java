...
public class RecommendLeftAdapter extends BaseAdapter {
    ...
    public RecommendLeftAdapter(Context context, String[] leftStr, boolean[] flagArray) {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg1 == null) {
            holder = new Holder();
            arg1 = LayoutInflater.from(context).inflate(R.layout.item_recommend_left, null);
